...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const startCounting = (setter: React.Dispatch<React.SetStateAction<number>>, stopNumber: number, interval: number) => {
      ...
      <div className="px-4 lg:px-14 w-full max-w-screen-2xl mx-auto relative">
        <div className="relative flex flex-col md:flex-row items-center justify-between p-4">
          <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            <h1 className="text-3xl md:text-7xl text-white font-extrabold mb-4 leading-tight animate-fade-in">
              {slide.title}
            ...
            <div className="flex justify-start gap-10 mt-20">
              <div className="text-center mx-4">
                <TfiBarChart className="text-4xl text-brandPrimary mb-2" size={50} />
                <p className="text-2xl text-brandPrimary font-bold">{count1}</p>
                <p className="text-base text-white">Images</p>
              </div>
              <div className="text-center mx-4">
                <TfiBarChartAlt className="text-4xl text-brandPrimary mb-2" size={50} />
